...
class RiderAccountSettings extends StatefulWidget {
  final String userId;

  const RiderAccountSettings({Key? key, required this.userId}) : super(key: key);

  @override
  _BuyerAccountSettingsState createState() => _BuyerAccountSettingsState();
}

class _BuyerAccountSettingsState extends State<RiderAccountSettings> {
